...
| CLI | picocli 4.7.7 | Concrete `world.mongoose.banteng.app` command parsing, validation, usage, and exit codes. It is a library at the composition root, not a runtime framework. <https://picocli.info/> |
