...
final class DecomposeToastV17ProgramLayoutTest implements RewriteTest {
  private static final String LEGACY_OWNER = "world.mongoose.banteng.persistence.ToastV17ProgramLayout";
  private static final String MODEL_TYPE = "world.mongoose.banteng.bytecode.ToastV17ProgramModel";
  private static final List<TypeMove> TYPE_MOVES =
      List.of(
          move("LayoutCompiler", "world.mongoose.banteng.bytecode.LayoutCompiler"),
          move("VectorBuilder", "world.mongoose.banteng.bytecode.VectorBuilder"),
          model("CallKind"),
          model("CallBoundary"),
  ...
  public void defaults(RecipeSpec spec) {
    spec.recipeFromResources("world.mongoose.banteng.persistence.DecomposeToastV17ProgramLayout")
        .parser(
  ...
  private static TypeMove model(String nestedName) {
    return move(nestedName, "world.mongoose.banteng.bytecode.ToastV17ProgramModel$" + nestedName);
  }
  ...
  private static String consumerAfter() {
    StringBuilder source =
        new StringBuilder(
            ...
            import world.mongoose.banteng.bytecode.VectorBuilder;
