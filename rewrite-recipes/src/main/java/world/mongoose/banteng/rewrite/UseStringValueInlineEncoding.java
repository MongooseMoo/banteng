...
public final class UseStringValueInlineEncoding extends Recipe {
  private static final String STRING_VALUE_TYPE = "world.mongoose.banteng.value.MooValue.StringValue";
  ...
  public TreeVisitor<?, ExecutionContext> getVisitor() {
    return new JavaVisitor<ExecutionContext>() {
      ...
      private final JavaTemplate decode =
          JavaTemplate.builder("#{any(world.mongoose.banteng.value.MooValue.StringValue)}.text()")
              .contextSensitive()
              .build();
